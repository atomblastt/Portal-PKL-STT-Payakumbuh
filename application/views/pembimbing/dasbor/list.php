    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border" style="background-color: #3c8dbc;">  
            <h3 align="center"><b><font color="white"><?php echo $user->nama_pembimbing; ?></font></b></h3>
            <br>
          </div>
              ...
              <div class="col-md-3 col-lg-3 " align="center">
                <img alt="Foto Mahasiswa" src="<?php
                  echo base_url('assets/upload/image/'.$user->gambar_p_lapangan);
           ...
           <div id="Modal_Foto" class="modal fade">
            ...
            <!--<form action="<?php //echo site_url('pembimbing/bimbingan/tambah'); ?>" method="post" enctype="multipart/form-data"> -->
              <?php echo form_open_multipart('pembimbing/dasbor/foto/'. $user->id_pembimbing); ?>
            ...
            <div class="col-md-5">
              <input type="file" name="gambar_p_lapangan" class="form-control" required="required">
            </div>
          </div>
                </div>
        ...
        <!-- MODAL ganti pass -->
           <div id="Modal_Edit_Pass" class="modal fade">
            <div class="modal-dialog">
            <!--<form action="<?php //echo site_url('pembimbing/bimbingan/tambah'); ?>" method="post" enctype="multipart/form-data"> -->
              <?php echo form_open_multipart('pembimbing/dasbor/edit/'. $user->id_user); ?>
                <div class="modal-content">
                  <div class="modal-header" style="background-color: #3c8dbc;">
        ...
        <!-- MODAL ganti pass -->
           <div id="Modal_Edit_Bio" class="modal fade">
            <div class="modal-dialog">
            <!--<form action="<?php //echo site_url('pembimbing/bimbingan/tambah'); ?>" method="post" enctype="multipart/form-data"> -->
              <?php echo form_open_multipart('pembimbing/dasbor/edit_bio/'. $user->id_pembimbing); ?>
                <div class="modal-content">
                  <div class="modal-header" style="background-color: #3c8dbc;">
                ...
                <div class="modal-body">
                  <div class="form-group row">
                    ...
                    <div class="col-md-5">
                      <input type="text" name="nama_pembimbing" class="form-control" value="<?php echo $user->nama_pembimbing ?>" required="required">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <label class="col-md-4 control-label">Instusi</label>
                    <div class="col-md-5">
                      <input type="text" name="instusi" class="form-control" value="<?php echo $user->instusi ?>" required="required">
                    </div>
                  </div>
