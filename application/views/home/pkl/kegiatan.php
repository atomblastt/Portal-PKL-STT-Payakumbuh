    ...
    <div class="col-md-4">
      <div class="box box-success">
        <div class="box-header">  
          <h2><b><?php echo $user->nama_mahasiswa; ?></b></h2>
      ...
      <div class="col-md-12">
        <div class="box box-info">
          ...
          <div class="box-header with-border">
              ...
              <?php if ($cek->tanggal_update == date("Y-m-d")): ?>
              
              <a href="#" class="btn btn-primary btn-lg" onclick="alert('ANDA SUDAH MENGISI KEGIATAN UNTUK HARI INI')"><i class="fa fa-plus"></i> Tambah</a>
              ...
              <a href="<?php echo base_url('cetak/cetak/kegiatan/'.$user->id_user) ?>" class="btn btn-success btn-lg"><span class="fa fa-print"></span> Cetak Kegiatan</a>
...
<table id="example1" class="table table-bordered table-striped">
    ...
    <tr>
      <td><?php echo $no++ ?></td>
      <td><?php echo $user->tanggal_update ?> / <?php echo $user->waktu_update ?></td>
